...
SERVER_CMDLINE="DM-Rankin?Game=SkaarjPack.Invasion?AdminName=Admin?AdminPassword=W1ldFl0w3r5?Mutator=TURRPG2.MutTURRPG,TURMMutations.MutMMutations,NewAssaultRifle.MutTURWeaponry"
SERVER_PORT="7777"

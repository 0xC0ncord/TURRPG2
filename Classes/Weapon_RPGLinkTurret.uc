...
class Weapon_RPGLinkTurret extends Weapon_LinkTurret
    config(user)
    HideDropDown
    CacheExempt;
...
function bool FocusOnLeader(bool bLeaderFiring)
{
    ...
    if ( (Vehicle(LeaderPawn) != None)
        || ( (LinkGun(LeaderPawn.Weapon) != None))
...
defaultproperties
{
     FireModeClass(0)=Class'FM_RPGLinkTurret_Fire'
     FireModeClass(1)=Class'FM_RPGLinkTurret_AltFire'
}

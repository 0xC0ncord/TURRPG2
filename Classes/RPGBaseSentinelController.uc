...
class RPGBaseSentinelController extends TurretController;
...
function Tick(float DeltaTime)
{
    ...
    if(TimeSinceCheck > 1.0)
    {
        ...
        while (C != None)
        {
            ...
            && VSize(C.Pawn.Location - Pawn.Location) < TargetRange && !C.Pawn.IsA('ParentBlob') && FastTrace(C.Pawn.Location, Pawn.Location)

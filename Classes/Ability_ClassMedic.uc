...
defaultproperties
{
    ...
    ClassTreeInfos(1)=(AbilityClass=Class'Ability_LoadedMedic',Row=3,Column=3,RequiredByAbilities=((Index=4,Levels=((Level=1))),(Index=5,Levels=((Level=1))),(Index=6,Levels=((Level=1))),(Index=7,Levels=((Level=1)))))
    ...
    ClassTreeInfos(4)=(AbilityClass=Class'Ability_ExpHealing',Row=5,Column=2)
    ClassTreeInfos(5)=(AbilityClass=Class'Ability_MedicAdrenalReserve',Row=5,Column=3)
    ClassTreeInfos(6)=(AbilityClass=Class'Ability_MedicAura',Row=5,Column=4)
    ClassTreeInfos(7)=(AbilityClass=Class'Ability_ComboTeamBooster',Row=5,Column=5)

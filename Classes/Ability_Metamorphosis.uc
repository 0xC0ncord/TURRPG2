...
{
    if(Damage > 0 && Monster(InstigatedBy) != None && PlayerController(InstigatedBy.Controller) != None)
...
{
    if(Damage > 0 && Monster(Injured) != None && PlayerController(Injured.Controller) != None)

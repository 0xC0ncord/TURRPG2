...
class MorphMonster_SkaarjPupae extends MorphMonster;
...
defaultproperties
{
     TauntAnimNames(1)="Pick"
     TauntAnimNames(2)="Tear"
     TauntAnims(1)="Pick"
     TauntAnims(2)="Tear"
     TauntSounds(1)=Sound'SkaarjPack_rc.Pupae.munch1p'
     TauntSounds(2)=Sound'SkaarjPack_rc.Pupae.tear1pp'
     FireAnims(0)="Bite"
     FireAnims(1)="Stab"
     FireAnims(2)="Lunge"
     DeathAnims(0)="Dead"

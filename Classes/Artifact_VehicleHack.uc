...
defaultproperties
{
    ...
    RedOverlay=Material'TURRPG2.Overlays.VHackRed'
    BlueOverlay=Material'TURRPG2.Overlays.VHackBlue'
    GreenOverlay=Material'TURRPG2.Overlays.VHackGreen'
    GoldOverlay=Material'TURRPG2.Overlays.VHackGold'
    MaxRadius=512.000000
    MaxRunningRadius=512.000000
    CostPerSec=10
    MinActivationTime=5.000000
    IconMaterial=Texture'TURRPG2.ArtifactIcons.VehicleHack'

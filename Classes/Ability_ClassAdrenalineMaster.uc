...
defaultproperties
{
    ...
    ClassTreeInfos(1)=(AbilityClass=Class'Ability_LoadedArtifacts',Row=3,Column=3,RequiredByAbilities=((Index=6,Levels=((Level=4)))))
    ...
    ClassTreeInfos(5)=(AbilityClass=Class'Ability_AmmoRegen',Row=3,Column=7,RequiredByAbilities=((Index=7,Levels=((Level=1)))))
    ClassTreeInfos(6)=(AbilityClass=Class'Ability_ArtifactMastery',Row=5,Column=3)
    ClassTreeInfos(7)=(AbilityClass=Class'Ability_Denial',Row=5,Column=7)
